...
var FormFill = function (_AlertMsg) {
    _inherits(FormFill, _AlertMsg);

    function FormFill(config) {
        _classCallCheck(this, FormFill);

        var _this = _possibleConstructorReturn(this, (FormFill.__proto__ || Object.getPrototypeOf(FormFill)).call(this));

        _this.$form = config.$form;
        _this.url = config.url;
        _this.method = config.method ? config.method : 'get';
        _this.token = config.token;
        _this.data = config.data;
        _this.mapList = config.mapList;
    ...
    _createClass(FormFill, [{
        ...
        key: 'fillForm',
        value: function fillForm(json) {
            $.each(this.mapList, function (name, $elemet) {
                if ($elemet && json[name]) {
        ...
        key: 'fill',
        value: function fill(value, $elemet) {
...
var FormSave = function (_AlertMsg2) {
    _inherits(FormSave, _AlertMsg2);

    function FormSave(config) {
        _classCallCheck(this, FormSave);

        var _this2 = _possibleConstructorReturn(this, (FormSave.__proto__ || Object.getPrototypeOf(FormSave)).call(this));

        _this2.$btn = config.$btn;
        _this2.$form = config.$form;
